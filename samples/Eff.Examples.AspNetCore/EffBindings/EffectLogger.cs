namespace Nessos.Eff.Examples.AspNetCore.EffBindings
{
    ...
    public struct PersistedEffect
    {
        ...
        /// </summary>
        public static PersistedEffect FromCompletedAwaiter<TResult>(EffAwaiterBase<TResult> awaiter)
        {
        ...
        ///</summary>
        public void WriteToAwaiter<TResult>(EffAwaiterBase<TResult> awaiter)
        {
            if (awaiter.IsCompleted)
            {
